        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    ...
                    <a href="#" title="" class="inline-flex items-center px-6 py-4 mt-6 font-semibold text-white transition-all duration-200 bg-red-500 rounded-full lg:mt-8" role="button">
                     Contact Us
