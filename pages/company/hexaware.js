...
const faqsList = [
  {
    q: "What is the eligibility criteria for Hexaware recruitment?",
  ...
  {
    q: "Does Hexaware provide training for freshers?",
    a: "Yes, Hexaware provides training programs focused on technical and soft skills development for freshers.",
  },
  {
    q: "What are the roles offered for freshers at Hexaware?",
    a: "Hexaware offers roles such as Graduate Engineer Trainee, Software Engineer, and Senior Software Engineer.",
  },
  {
    q: "What is the test pattern for Hexaware's recruitment process?",
  ...
  {
    q: "Does Hexaware offer opportunities for international projects?",
    a: "Yes, Hexaware offers opportunities to work on global projects based on performance and business requirements.",
  },
];
      ...
      <div className="custom-screen text-gray-800">
        <div className="max-w-xl text-left mx-auto">
          ...
          <p className="mt-2 text-base sm:text-lg text-gray-600">
            Here are the most commonly asked questions about Hexaware.
          </p>
        </div>
    ...
    <main className="bg-gray-50 min-h-screen py-10 px-6 md:px-20">
      ...
      <header className="mb-10">
        ...
        <p className="text-gray-600 mt-2">
          A global leader in IT services and consulting, Hexaware leverages technology to drive innovation and deliver transformative solutions to clients worldwide.
        </p>
      </header>

      {/* About Hexaware */}
      <section className="mt-10">
        <h2 className="text-3xl font-bold text-red-600 mb-4">About Hexaware Technologies</h2>
        <p className="text-gray-600 leading-relaxed">
          Founded in 1990, Hexaware Technologies is a global IT services company headquartered in Mumbai, India. With a presence in over 30 countries, Hexaware offers services in application development, infrastructure management, and business process outsourcing.
        </p>
      </section>
      ...
      <section className="mt-16">
        ...
        <p className="text-gray-600 leading-relaxed">
          The HR interview focuses on assessing the candidate's fit within the company culture, communication skills, and alignment with Hexaware's values.
        </p>
      </section>
