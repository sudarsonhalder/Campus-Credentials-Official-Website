            ...
            >
                <div>
                    <div className="space-y-5 max-w-3xl mx-auto text-center">
                        <h1 className="text-4xl bg-clip-text  font-extrabold mx-auto sm:text-6xl"
                            style={{
                        ...
                        <p className="max-w-xl mx-auto text-gray-800">
                            Gain control of your business's growth with Campus Credentials's comprehensive marketing, automation, and email marketing platform.
                        </p>
                        <div className="flex justify-center font-medium text-sm">
                            <NavLink
                                href="/#pricing"
                                className="flex items-center text-black bg-red-600 hover:bg-red-500 active:bg-red-700 "
                            >
                                Get Started
