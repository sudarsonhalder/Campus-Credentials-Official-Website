                ...
                <div className="custom-screen items-center md:flex">
                    ...
                    <div className={`flex-1 items-center mt-8 text-gray-800 md:font-medium md:mt-0 md:flex ${state ? 'block' : 'hidden'} `}>
                        ...
                        <div className="gap-x-6 items-center justify-end mt-6 space-y-6 md:flex md:space-y-0 md:mt-0">
                            <Link href="/login" className="block hover:text-gray-800">
                                Sign in
                            </Link>
                            <NavLink href="/pricing" className="flex items-center justify-center gap-x-1 text-sm text-white font-medium bg-red-500 border border-gray-500 active:bg-gray-900 md:inline-flex">
                             Contact Us
